...
public class ApiCaller {
    ...
    public MarvelCharacterResponse callMarvelForCharacterWithFullName(String characterName) {
        String limit = "3";
        ...
        return restTemplate.getForObject(marvelCharacterUrl, MarvelCharacterResponse.class, characterName, limit, ts, marvelPublicKey, hash);


    }

    public MarvelComicsResponse callMarvelForComics(String characterId, Long offset) {
        String limit = "5";
        ...
        return restTemplate.getForObject(marvelComicsUrl, MarvelComicsResponse.class, characterId, limit, offset, ts, marvelPublicKey, hash);
    }
